...
TRANSLATIONS = {
    "en": {
        ...
        "char_file": "File:",
        "char_tip": "Your 3D character file (FBX or DAE) with a Mixamo skeleton.\nIMPORTANT: The character must be in A-Pose (arms angled down ~45°).\nT-Pose (arms straight out) will break the retargeting.",
        "char_format": "(.fbx / .dae  —  Mixamo skeleton in A-POSE)",
        "char_warn": "⚠  Requires A-Pose character (arms ~45° down). T-Pose will not work correctly.",
        "blender": "Blender",
    ...
    "es": {
        ...
        "char_file": "Archivo:",
        "char_tip": "Tu archivo de personaje 3D (FBX o DAE) con esqueleto Mixamo.\nIMPORTANTE: El personaje debe estar en A-Pose (brazos inclinados ~45° hacia abajo).\nT-Pose (brazos extendidos) romperá el retargeting.",
        "char_format": "(.fbx / .dae  —  esqueleto Mixamo en A-POSE)",
        "char_warn": "⚠  Requiere personaje en A-Pose (brazos ~45° abajo). T-Pose no funcionará correctamente.",
        "blender": "Blender",
    ...
    "fr": {
        ...
        "char_file": "Fichier:",
        "char_tip": "Votre fichier de personnage 3D (FBX ou DAE) avec un squelette Mixamo.\nIMPORTANT : Le personnage doit être en A-Pose (bras inclinés ~45° vers le bas).\nT-Pose (bras tendus) cassera le retargeting.",
        "char_format": "(.fbx / .dae  —  squelette Mixamo en A-POSE)",
        "char_warn": "⚠  Nécessite un personnage en A-Pose (bras ~45° vers le bas). T-Pose ne fonctionnera pas correctement.",
        "blender": "Blender",
    ...
    "pt": {
        ...
        "char_file": "Arquivo:",
        "char_tip": "Seu arquivo de personagem 3D (FBX ou DAE) com esqueleto Mixamo.\nIMPORTANTE: O personagem deve estar em A-Pose (braços inclinados ~45° para baixo).\nT-Pose (braços estendidos) quebrará o retargeting.",
        "char_format": "(.fbx / .dae  —  esqueleto Mixamo em A-POSE)",
        "char_warn": "⚠  Requer personagem em A-Pose (braços ~45° abaixo). T-Pose não funcionará corretamente.",
        "blender": "Blender",
