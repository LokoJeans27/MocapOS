...
def parse_args_to_cfg():
    ...
    parser.add_argument("--output_root", type=str, default=None, help="by default to outputs/results")
    ...
    parser.add_argument("--skip_render", action="store_true", help="If true, skip video rendering (inference only)")
...
if __name__ == "__main__":
    ...
    # Exports the body mesh you see over the video as an exact .abc. Never fails the run.
    try:
